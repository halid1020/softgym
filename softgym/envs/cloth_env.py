...
class ClothEnv(FlexEnv):
    def __init__(self, observation_mode, action_mode, num_picker=2, render_mode='particle', picker_radius=0.02, picker_threshold=0.04, particle_radius=0.00625, **kwargs):
